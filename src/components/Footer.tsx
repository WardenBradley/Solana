...
export const Footer: FC = () => {
  const [state, handleSubmit] = useForm("movqjjaw");

  if (state.succeeded) {
    return (
      <h1
        className="md:text-5xl/tight my-4 
  ...
  return (
    <footer className="bg-default-950/40 backdrop-blur-3xl">
      <div className="container py-20 lg:px-20">
        <div
          className="grid grid-cols-2 gap-10 lg:grid-cols-12
      lg:gap-16"
        >
                ...
                <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="email"
                      name="email"
                      className="bg-default-950/60 pe-40
                      ps-4 h-12 w-full rounded-lg border-white/10
                      py-4 text-white backdrop-blur-3xl focus:border-white/10
                      focus:ring-0"
                    />
                    ...
                    <button
                      ...
                      hover:border-primary-hover border-primary bg-primary
                      end-[6px] absolute top-[6px] inline-flex h-9 items-center
                      justify-center gap-2 rounded-md px-6 text-white transition-all"
                    >
                      Subscribe
                    </button>
                  </div>
      ...
      <div className="border-t border-white/10 py-6">
        <div
          className="md:text-start container flex h-full flex-wrap
        items-center justify-center gap-4 text-center md:justify-between
        lg:px-20"
        >
          <p className="text-default-400 text-base font-medium">
            ...
            <a href="#">
              ...
              <i
                data-lucide="heart"
                className="inline h-4 w-4 fill-red-500
                text-red-500"
              ></i>
              by @theBLCcoders
            </a>
