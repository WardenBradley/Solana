...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  return (
    <div
      className="bg-bkg-1 pointer-events-auto z-50 mx-4 mt-2 mb-12 w-full max-w-sm
      ...
      <div className="p-4">
        <div className="flex items-center">
          <div className="flex-shrink-0">
            ...
            {type === "info" ? (
              <CheckCircleIcon className="text-info mr-1 h-8 w-8" />
            ) : null}
            {type === "error" ? (
            ...
            {txid ? (
              <div className="flex flex-row">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="link-accent link flex
                      flex-row"
                >
                  <NotificationSVG />
