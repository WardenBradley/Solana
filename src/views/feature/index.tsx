  ...
  const features = [
    {
      ...
      description: "Some long-ass nondescript description",
  ...
  return (
    <section className="py-20">
      <div className="container">
        ...
        <div
          className="bg-default-950/40 flex flex-wrap items-center
          ...
          {features.map((list, index) => (
            ...
            >
              <div className="p-8 sm:p-10">
                <div
                  className="bg-primary/10 text-primary mb-10 inline-flex h-16
                ...
                <a
                  ...
                  gap-2 rounded-full border border-white/10 px-6 py-2 text-white
