              ...
              <div className="lg:ps-0 flex h-full flex-col p-10">
                ...
                <div className="my-auto pb-6 text-center">
                  <h4 className="mb-4 text-2xl font-bold text-white">
                    Send email to use for more detallos
                  </h4>

                  <p className="text-default-300 mx-auto mb-5 max-w-sm">
                    Send message to let us know more about you!
                  </p>
                  ...
                  <div className="text-start">
                    <form onSubmit={handleSubmit}>
                      ...
                      <textarea
                        ...
                        block w-full rounded border-white/10 bg-transparent 
                        py-1.5 px-3 text-white/80 focus:border-white/25
                        focus:ring-transparent"
                        placeholder="message"
                      ></textarea>
                      <ValidationError
                    ...
                    <div className="mb-6 text-center">
                      ...
                      duration-500"
                      >
                        <span className="fw-bold">Manda un Mensaje</span>
                      </button>
                      <CloseModal />
                    </div>
                  </div>
