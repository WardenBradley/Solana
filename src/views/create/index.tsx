...
export const CreateView: FC = ({ setOpenCreateModal }) => {
    ...
    if (file) {
      try {
        ...
        const response = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: "03603cf59b407ee50571",
            pinata_secret_api_key:
              "4d0350bc0d340775cc7c915a79d01c77096d510735e62340648bee773fdc51b0",
  ...
  return (
    <>
      {isLoading && (
        <div
          className="absolute top-0 left-0 z-50 flex h-screen w-full items-center
              ...
              <div className="grid gap-10 lg:grid-cols-2">
                <div className="ps-4 hidden py-4 pt-10 lg:block">
                  ...
                  <textarea
                    ...
                    className="border-default-200 relative mt-48 block w-full rounded
                ...
                <div className="lg:ps-0 flex h-full flex-col p-10">
                  ...
                  <div className="my-auto pb-6 text-center">
                    ...
                    <div className="mt-5 w-full text-center">
                      ...
                      <div className="mb-6 text-center">
                        <a
                          href={`https://explorer.solana.com/${tokenMintAddress}?cluster=${networkConfiguration}`}
                          target="_blank"
                          rel="noreferrer"
                          className="bg-primary-600/90 hover:bg-primary-600 group
                          mt-5 inline-flex w-full items-center justify-center rounded-lg px-6
                          py-2 text-white backdrop-blur-2xl transition-all duration-500"
                        >
